...
export default function Card1({ name = "testcard", description, color = "white" }) {
    return (
        <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group">
            ...
            <div className="mb-4">
                ...
                <h2 className={`text-xl font-bold ${color} mb-2 group-hover:text-gray-300 transition-colors duration-200 `}>
                    {name}
                </h2>
            </div>
